...
* The following dependencies are not known to work with Spring Native: 'Spring Boot DevTools, Spring Configuration Processor, Eureka Server, Eureka Discovery Client, Cloud Bootstrap'. As a result, your application may not work as expected.
...
```
$ docker run --rm -p 8080:8080 ExamSystem:0.0.1-SNAPSHOT
```
